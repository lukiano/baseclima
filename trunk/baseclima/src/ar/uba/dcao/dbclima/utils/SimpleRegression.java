 ...
 * </ul>
 *
 * @version $Revision: 1.2 $ $Date: 2007/10/25 02:52:50 $
 */
public class SimpleRegression implements Serializable {
    ...
    */
    ...
    public double getSlopeConfidenceInterval(double alpha) {
        ...
        return getSlopeStdErr() *
            getTDistribution().inverseF(1d - alpha / 2d);
    }
    ...
    public double getSignificance() {
        return 2d* (1.0 - getTDistribution().cdf(
    ...
    */
     ...
     */
    private ContinuousDistribution getTDistribution() {
        return new StudentDist(n - 2);
    }
}
