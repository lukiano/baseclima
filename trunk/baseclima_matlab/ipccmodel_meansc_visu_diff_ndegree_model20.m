...
function ipccmodel_meansc_visu_diff_ndegree_model20(scen, cvar, ndegree, year20, month, regional_masks, cluster_filename, cluster_number_mask)
...
if (dirString == 0)
    ...
    for tn = truenames
        ...
        do_diff_model21_model20(cvar, fullname21, fullname20, model_name, month, ndegree, regional_masks, cluster_filename, cluster_number_mask);
    end
end
...
function do_diff_model21_model20(cvar, file_scen21, file_scen20, model_name, month, ndegree, regional_masks, cluster_filename, cluster_number_mask)
