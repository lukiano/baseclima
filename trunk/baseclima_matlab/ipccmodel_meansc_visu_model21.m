...
function ipccmodel_meansc_visu_model21(scen, cvar, month, year21, regional_masks, cluster_filename, cluster_number_mask)
...
if (dirString == 0)
    ...
    for tn = truenames
        ...
        fullname = fullfile(dirString, [cvar '_' scen '_' model_name '_' run '_year' num2str(year21) '.mat']);
...
%Save picture as PNG.
%eval(['print -dpng ' cvar '_' model_name '_21_' titstr{month+1}]);
