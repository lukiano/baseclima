...
function ipccmodel_meansc_diagscen_ndegree(scen, cvar, ndegree, year20)
    ...
    if (dirString == 0)
        ...
        rexp = regexp(names, [cvar '_' scen '_' model_name '_' run '_' num2str(ndegree) 'degree.mat']);
        contador = 1;
        truenames = cell(0);
        for i = 1:length(rexp)
        ...
        datadirout = '';
        fileout=[datadirout cvar '_' scen '_ndegree' num2str(ndegree) '_year' num2str(year20) '.mat' ];
