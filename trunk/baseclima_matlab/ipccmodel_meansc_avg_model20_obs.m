...
function ipccmodel_meansc_avg_model20_obs(scen, cvar, year20)
    ...
    if (dirString == 0)
        ...
        for tn = truenames
            ...
            fullname21 = fullfile(dirString, [cvar '_' scen '_' model_name '_' run '_year' num2str(year20) '.mat']);
            fullname20 = fullfile(dirString, [cvar '_obs_cru_' run '_year' num2str(year20) '.mat']);
        ...
        datadirout = '';
        fileout=[datadirout cvar '_obs_year' num2str(year20) '.mat' ];
