...
function ipccmodel_meansc_visu_diff_model20_obs(cvar, year20, month, regional_masks, cluster_filename, cluster_number_mask)
...
if (dirString == 0)
    ...
    for tn = truenames
        ...
        do_diff_model_20c3m(cvar, file_20c3m, file_cru, model_name, month, regional_masks, cluster_filename, cluster_number_mask);
    end
end
...
function do_diff_model_20c3m(cvar, file_scen, file_cru, model_name, month, regional_masks, cluster_filename, cluster_number_mask)
