...
/**
 * Cuadro de dialogo para importar un nuevo conjunto de datos satelitales.
 * Tomar en cuenta que no hay control de solapamiento de datos. Se recomienda borrar
 * el dataset con datos satelitales. 
 *
 */
@SuppressWarnings("serial")
public class CreateSatellitalDatasetDialog extends JDialog {
  ...
  private ActionListener filesButtonListener = new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      ...
      if (fc.showOpenDialog(CreateSatellitalDatasetDialog.this) == JFileChooser.APPROVE_OPTION) {
  ...
  public CreateSatellitalDatasetDialog(JFrame owner, RunnableWorker worker) {
    super(owner, "Import new Satellital Dataset", true);
    this.worker = worker;
    this.pack();
    this.initGUI();
    this.validate();
