...
function ipccmodel_meansc_visu_avg_model20_obs(scen, cvar, year20, month, regional_masks, cluster_filename, cluster_number_mask)

% This program visualizes the climate change diagnostics

datadirout = ''; %/Users/Shared/IPCC/Interp2Cru/';
filein = [datadirout cvar '_obs_year' num2str(year20) '.mat' ];
