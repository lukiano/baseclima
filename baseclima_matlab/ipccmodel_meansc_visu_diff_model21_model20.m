...
function ipccmodel_meansc_visu_diff_model21_model20(scen, cvar, month, year21, year20, regional_masks, cluster_filename, cluster_number_mask)
...
if (dirString == 0)
    ...
    for tn = truenames
        ...
        do_diff_model21_model20(cvar, fullname21, fullname20, model_name, month, regional_masks, cluster_filename, cluster_number_mask);
    end
end
...
function do_diff_model21_model20(cvar, file_scen21, file_scen20, model_name, month, regional_masks, cluster_filename, cluster_number_mask)
